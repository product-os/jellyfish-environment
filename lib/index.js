 ...
 * @public
 *
 * @param {Object} env - only use if you want to override `process.env` for testing purposes.
 ...
 * }
 */
exports.isProduction = (env = process.env) => {
 ...
 * }
 */
exports.isDevelopment = (env = process.env) => {
 ...
 * }
 */
exports.isCI = (env = process.env) => {
	return env.hasOwnProperty('CI')
}
...
exports.logentries = {
	...
	region: process.env.LOGENTRIES_REGION
}
...
exports.fileStorage = {
	driver: exports.cleanString(process.env.FS_DRIVER)
}
...
exports.backend = {
	services: exports.cleanString(process.env.BACKEND_SERVICES)
}
